...
primitives = [ ("b.+", plus)
             ...
             , ("isBool",       oneArg' "isBool"       isBool)
             , ("isInteger",    oneArg' "isInteger"    isInteger)
             , ("isRational",   oneArg' "isRational"   isRational)
             , ("isScalar",     oneArg' "isScalar"     isScalar)
             , ("isFloat",      oneArg' "isFloat"      isFloat)
             , ("isChar",       oneArg' "isChar"       isChar)
             , ("isString",     oneArg' "isString"     isString)
             , ("isCollection", oneArg' "isCollection" isCollection)
             , ("isHash",       oneArg' "isHash"       isHash)
             , ("isTensor",     oneArg' "isTensor"     isTensor)
