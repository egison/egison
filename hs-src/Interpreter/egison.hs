...
main = do args <- getArgs
          ...
          case opts of
            ...
            Options {optEvalString = mExpr, optExecuteString = mCmd, optPrompt = prompt, optShowBanner = bannerFlag, optNoIO = noIOFlag} -> do
...
printHelp = do
  ...
  putStrLn "  --command, -c string     Evaluate the argument string"
